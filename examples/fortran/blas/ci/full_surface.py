...
from examples.fortran.blas.routine_inventory import ALL_ROUTINES
from examples.fortran.blas.tests.helpers import assert_runtime_smoke
...
def test_ci_complete_prik_surface_reuses_example_extension(prik_blas):
    ...
    assert missing == []
    assert_runtime_smoke(prik_blas)
