...
def test_dlauum_forms_triangular_product(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dlauum("U", 1, prik_a, 1, 0)
    f2py_result = f2py_lapack.dlauum(b"U", 1, f2py_a, 1, 0)
...
def test_dpftrf_factorizes_rfp_spd_matrix(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpftrf("N", "U", 1, prik_a, 0)
...
def test_dpftri_inverts_rfp_cholesky_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpftri("N", "U", 1, prik_a, 0)
...
def test_dpftrs_solves_from_rfp_cholesky_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpftrs("N", "U", 1, 1, factor, prik_b, 1, 0)
    f2py_result = f2py_lapack.dpftrs(b"N", b"U", 1, 1, factor, f2py_b, 1, 0)
...
def test_dpocon_estimates_spd_reciprocal_condition(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpocon(
        "U", 1, factor.copy(order="F"), 1, 4.0, 0.0, np.empty(3), np.empty(1, dtype=np.int32), 0
    )
    f2py_result = f2py_lapack.dpocon(
        b"U", 1, factor.copy(order="F"), 1, 4.0, 0.0, np.empty(3), np.empty(1, dtype=np.int32), 0
    )
...
def test_dposv_solves_spd_system(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dposv("U", 1, 1, prik_a, 1, prik_b, 1, 0)
    f2py_result = f2py_lapack.dposv(b"U", 1, 1, f2py_a, 1, f2py_b, 1, 0)
...
def test_dpotri_inverts_cholesky_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpotri("U", 1, prik_a, 1, 0)
    f2py_result = f2py_lapack.dpotri(b"U", 1, f2py_a, 1, 0)
...
def test_dpotrs_solves_from_cholesky_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpotrs("U", 1, 1, factor.copy(order="F"), 1, prik_b, 1, 0)
    f2py_result = f2py_lapack.dpotrs(b"U", 1, 1, factor.copy(order="F"), 1, f2py_b, 1, 0)
...
def test_dppcon_estimates_packed_spd_condition(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dppcon("U", 1, factor, 4.0, 0.0, np.empty(3), np.empty(1, dtype=np.int32), 0)
...
def test_dppsv_solves_packed_spd_system(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dppsv("U", 1, 1, prik_ap, prik_b, 1, 0)
    f2py_result = f2py_lapack.dppsv(b"U", 1, 1, f2py_ap, f2py_b, 1, 0)
...
def test_dpptrf_factorizes_packed_spd_matrix(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpptrf("U", 1, prik_ap, 0)
...
def test_dpptri_inverts_packed_cholesky_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpptri("U", 1, prik_ap, 0)
...
def test_dpptrs_solves_from_packed_cholesky_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpptrs("U", 1, 1, factor, prik_b, 1, 0)
    f2py_result = f2py_lapack.dpptrs(b"U", 1, 1, factor, f2py_b, 1, 0)
...
def test_dpstf2_reconstructs_pivoted_cholesky(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpstf2("U", 1, prik_a, 1, prik_piv, 0, -1.0, np.empty(2), 0)
    f2py_result = f2py_lapack.dpstf2(b"U", 1, f2py_a, 1, f2py_piv, 0, -1.0, np.empty(2), 0)
...
def test_dpstrf_reconstructs_blocked_pivoted_cholesky(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dpstrf("U", 1, prik_a, 1, prik_piv, 0, -1.0, np.empty(2), 0)
    f2py_result = f2py_lapack.dpstrf(b"U", 1, f2py_a, 1, f2py_piv, 0, -1.0, np.empty(2), 0)
...
def test_dsfrk_updates_spd_matrix_in_rfp_storage(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dsfrk("N", "U", "N", 1, 2, 1.0, matrix, 1, 1.0, prik_c)
    f2py_result = f2py_lapack.dsfrk(b"N", b"U", b"N", 1, 2, 1.0, matrix, 1, 1.0, f2py_c)
