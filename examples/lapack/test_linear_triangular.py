...
def test_dtfsm_solves_with_rfp_triangular_factor(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtfsm("N", "L", "U", "N", "N", 2, 1, 1.0, rfp, prik_b, 2)
    f2py_result = f2py_lapack.dtfsm(b"N", b"L", b"U", b"N", b"N", 2, 1, 1.0, rfp, f2py_b, 2)
...
def test_dtfttp_converts_rfp_to_packed(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtfttp("N", "U", 2, rfp, prik_ap, 0)
...
def test_dtfttr_converts_rfp_to_full_triangular(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtfttr("N", "U", 2, rfp, prik_a, 2, 0)
    f2py_result = f2py_lapack.dtfttr(b"N", b"U", 2, rfp, f2py_a, 2, 0)
...
def test_dtpttf_converts_packed_to_rfp(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtpttf("N", "U", 2, packed, prik_rfp, 0)
...
def test_dtpttr_converts_packed_to_full_triangular(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtpttr("U", 2, packed, prik_a, 2, 0)
    f2py_result = f2py_lapack.dtpttr(b"U", 2, packed, f2py_a, 2, 0)
...
def test_dtrcon_estimates_triangular_reciprocal_condition(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtrcon(
        "1", "U", "N", 2, stored.copy(order="F"), 2, 0.0, np.empty(6), np.empty(2, dtype=np.int32), 0
    )
    f2py_result = f2py_lapack.dtrcon(
        b"1", b"U", b"N", 2, stored.copy(order="F"), 2, 0.0, np.empty(6), np.empty(2, dtype=np.int32), 0
    )
...
def test_dtrtri_inverts_triangular_matrix(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtrtri("U", "N", 2, prik_a, 2, 0)
    f2py_result = f2py_lapack.dtrtri(b"U", b"N", 2, f2py_a, 2, 0)
...
def test_dtrtrs_solves_triangular_system(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtrtrs("U", "N", "N", 2, 1, stored.copy(order="F"), 2, prik_b, 2, 0)
    f2py_result = f2py_lapack.dtrtrs(b"U", b"N", b"N", 2, 1, stored.copy(order="F"), 2, f2py_b, 2, 0)
...
def test_dtrttf_converts_full_triangular_to_rfp(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtrttf("N", "U", 2, stored.copy(order="F"), 2, prik_rfp, 0)
    f2py_result = f2py_lapack.dtrttf(b"N", b"U", 2, stored.copy(order="F"), 2, f2py_rfp, 0)
...
def test_dtrttp_converts_full_triangular_to_packed(prik_lapack, scipy_lapack, f2py_lapack):
    ...
    prik_scalars = prik_lapack.dtrttp("U", 2, stored.copy(order="F"), 2, prik_ap, 0)
    f2py_result = f2py_lapack.dtrttp(b"U", 2, stored.copy(order="F"), 2, f2py_ap, 0)
