...
| Cadence | Tools |
| --- | --- |
| Local pre-push | Blocking static analysis, focused documentation smoke, one compiled scalar-wrapper smoke test, maintainer-tool tests in `tests/tools/`, and workflow-safety tests in `tests/workflows/` |
