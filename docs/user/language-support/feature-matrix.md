...
<!-- PRIK_C_DOCS_START
| C parse, semantic IR, and `.pyi` inspection | Partially supported | [C inspection recipe](../examples/recipes/inspect-c-api.md), [C parser reference](../../developer/deferred/c-parser.md) | [C parser route](../../developer/codebase-map.md#cross-stage-hotspots) | [C parser fixtures](../../../tests/c/parsing/test_c_fixture_suite.py), [C semantic tests](../../../tests/c/semantics/conversion/) | Runtime wrapping of user-supplied C libraries is not implemented. |
