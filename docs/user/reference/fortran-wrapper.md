...
This reference describes the Python API generated by x2py for Fortran code. It
...
<!-- X2PY_C_DOCS_START
This reference covers the implemented wrapper for Fortran source inputs. x2py also
