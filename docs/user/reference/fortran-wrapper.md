...
- Arrays and pointers: [allocatables](../guide/allocatables.md),
  [pointers](../guide/pointers.md), [array results](../guide/arrays.md), and
  [NumPy argument contracts](../guide/arrays.md)
...
Python extension. prik compiles every supplied source in caller order, links all
...
prik does not discover missing sources, infer a dependency graph, or reorder
