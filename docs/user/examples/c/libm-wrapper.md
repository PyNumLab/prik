---
title: Build and Validate the C libm Library with PRIK
audience: users, advanced users
prerequisites: C support, semantic .pyi contracts
related: ../../language-support/c-support.md, ../../reference/cli-commands.md, ta-lib-wrapper.md
status: maintained
...
| NumPy | 2.5.1 in CI |
| C compiler | target-specific; see [Tested platforms](#tested-platforms) |
...
under [`examples/c/libm/`](../../../../examples/c/libm/).

---

## 2. Review the selected API

[`libm_probe.h`](../../../../examples/c/libm/libm_probe.h) contains only
`#include <math.h>`, so the active toolchain supplies every declaration.
[`iso_c99_routines.txt`](../../../../examples/c/libm/iso_c99_routines.txt) is the
...
<!-- prik-doc-source: examples/c/libm/build_prik.sh -->
```bash
...
<!-- prik-doc-source: examples/c/libm/tests/test_numerical.py::test_elementary -->
```python
...
- Platform declaration probe →
  [`libm_probe.h`](../../../../examples/c/libm/libm_probe.h)
- Reviewed function selection →
  [`iso_c99_routines.txt`](../../../../examples/c/libm/iso_c99_routines.txt)
- Public routine list →
  [`routine_inventory.py`](../../../../examples/c/libm/routine_inventory.py)
- Routine coverage checks →
  [`test_routine_coverage.py`](../../../../examples/c/libm/tests/test_routine_coverage.py)
- Copyable project instructions →
  [`examples/c/libm/README.md`](../../../../examples/c/libm/README.md)
...
- Use `source examples/c/libm/build_all.sh`; a child shell cannot preserve its
  exported `PYTHONPATH`.
...
The Real Libraries Portability workflow builds and runs the complete
60-function suite twice on every hosted target with Python 3.12:
