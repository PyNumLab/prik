...
`examples/bspline/native/`, so the example does not download code during its
build.
...
[`examples/bspline/`](../../../examples/bspline/).
...
```bash
python3 -m pytest -q examples/bspline/tests
```
...
<!-- prik-doc-source: examples/bspline/tests/test_procedural_api.py::test_db1sqad -->
```python
...
python3 -m pytest -q \
  examples/bspline/tests/test_procedural_api.py::test_db1ink
python3 -m pytest -q examples/bspline/tests -k db6
```

- Derived-type examples →
  [`test_object_oriented_api.py`](../../../examples/bspline/tests/test_object_oriented_api.py)
- Procedural numerical examples →
  [`test_procedural_api.py`](../../../examples/bspline/tests/test_procedural_api.py)
- Public surface and coverage check →
  [`test_routine_coverage.py`](../../../examples/bspline/tests/test_routine_coverage.py)
- Reviewed inventory →
  [`routine_inventory.py`](../../../examples/bspline/routine_inventory.py)
- Copyable project instructions →
  [`examples/bspline/README.md`](../../../examples/bspline/README.md)
...
- Use `source examples/bspline/build_all.sh`; executing it in a child shell does
...
[`examples/bspline/native/`](../../../examples/bspline/native/) are the
