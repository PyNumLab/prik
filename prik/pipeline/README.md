...
| `type_mapping_report.py` | Compiler-target facts converted through semantic IR and backend NumPy projection into a measured inspection record, rendered as Markdown on request. |
