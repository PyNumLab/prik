...
class PrimitiveScalarTypeRegistry:
    ...
    TYPES: ClassVar[dict[str, BackendScalarType]] = {
        **{name: replace(_BOOL_BACKEND_TYPE, semantic_name=name) for name in BOOLEAN_SEMANTIC_TYPE_NAMES},
        ...
        "UInt8": BackendScalarType(
            semantic_name="UInt8",
            c_spelling="uint8_t",
            fortran_spelling="integer(c_int8_t)",
            python_parse_unit="O",
            numpy_type_macro="NPY_UINT8",
            python_result_kind="numpy",
            python_type_name=NumpyDtypeRegistry.expression_for("UInt8"),
            python_module_result_kind="numpy",
            cfi_type_spelling="CFI_type_int8_t",
        ),
        "UInt16": BackendScalarType(
            semantic_name="UInt16",
            c_spelling="uint16_t",
            fortran_spelling="integer(c_int16_t)",
            python_parse_unit="O",
            numpy_type_macro="NPY_UINT16",
            python_result_kind="numpy",
            python_type_name=NumpyDtypeRegistry.expression_for("UInt16"),
            python_module_result_kind="numpy",
            cfi_type_spelling="CFI_type_int16_t",
        ),
        "UInt32": BackendScalarType(
            semantic_name="UInt32",
            c_spelling="uint32_t",
            fortran_spelling="integer(c_int32_t)",
            python_parse_unit="O",
            numpy_type_macro="NPY_UINT32",
            python_result_kind="numpy",
            python_type_name=NumpyDtypeRegistry.expression_for("UInt32"),
            python_module_result_kind="numpy",
            cfi_type_spelling="CFI_type_int32_t",
        ),
        "UInt64": BackendScalarType(
            semantic_name="UInt64",
            c_spelling="uint64_t",
            fortran_spelling="integer(c_int64_t)",
            python_parse_unit="O",
            numpy_type_macro="NPY_UINT64",
            python_result_kind="numpy",
            python_type_name=NumpyDtypeRegistry.expression_for("UInt64"),
            python_module_result_kind="numpy",
            cfi_type_spelling="CFI_type_int64_t",
        ),
        ...
        "Float128": BackendScalarType(
            semantic_name="Float128",
            c_spelling="long double",
            fortran_spelling="real(c_long_double)",
            python_parse_unit="O",
            numpy_type_macro="NPY_LONGDOUBLE",
            python_result_kind="numpy",
            python_type_name=NumpyDtypeRegistry.expression_for("Float128"),
            python_module_result_kind="numpy",
            cfi_type_spelling="CFI_type_long_double",
        ),
        ...
        "Complex256": BackendScalarType(
            semantic_name="Complex256",
            c_spelling="long double complex",
            fortran_spelling="complex(c_long_double_complex)",
            python_parse_unit="O",
            numpy_type_macro="NPY_CLONGDOUBLE",
            python_result_kind="numpy",
            python_type_name=NumpyDtypeRegistry.expression_for("Complex256"),
            python_module_result_kind="numpy",
            cfi_type_spelling="CFI_type_long_double_Complex",
        ),
    }
