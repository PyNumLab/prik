...
DERIVED_FIXTURES = Path(__file__).parents[3] / "derived_types" / "end_to_end" / "fixtures"
GENERIC_FIXTURES = Path(__file__).parents[3] / "generic_interfaces" / "end_to_end" / "fixtures"
