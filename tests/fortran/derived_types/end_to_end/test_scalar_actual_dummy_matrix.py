"""Compiled proof for every scalar-derived actual/dummy cell."""
...
def scalar_matrix(tmp_path_factory) -> MatrixBuild:
    output_dir = tmp_path_factory.mktemp("scalar_derived_matrix")
    ...
    return MatrixBuild(
        ...
        package.matrix_left_types,
        package.matrix_right_types,
        result,
    )
