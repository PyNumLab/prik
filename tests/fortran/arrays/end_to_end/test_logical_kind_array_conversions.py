...
_LOGICAL_KIND_ARRAY_SOURCE = (NATIVE_FIXTURES / "logical_kind_arrays.f90").read_text(encoding="utf-8")


_LOGICAL_POINTER_SOURCE = (NATIVE_FIXTURES / "logical_pointer_arrays.f90").read_text(encoding="utf-8")
